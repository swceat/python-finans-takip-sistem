...
class NewIncomeStatementEntry(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Yeni Gelir Tablosu Kaydı')
        ...
        # Başlık etiketi
        title_label = QLabel('Yeni Gelir Tablosu Kaydı')
        ...
        type_label = QLabel('Kalem Türü:')
        self.type_combo = QComboBox()
        self.type_combo.addItems(['Hasılat', 'Satışların Maliyeti', 'Faaliyet Giderleri',
        ...
        self.description_input.setPlaceholderText('Açıklama giriniz...')
    ...
    def save_entry(self):
        ...
        QMessageBox.information(
            self,
            'Başarılı',
            'Gelir tablosu kaydı başarıyla oluşturuldu!',
            QMessageBox.Ok
        )
